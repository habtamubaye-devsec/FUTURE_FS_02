...
const Create: React.FC = () => {
  ...
  return (
    <div className="flex flex-col w-full justify-around items-stretch h-full mx-auto max-w-sm">
      <div className="mb-12">
        <h3 className="text-center">What are we deciding on?</h3>
        <div className="text-center w-full">
          <input
            maxLength={100}
            onChange={(e) => setPollTopic(e.target.value)}
            className="box info w-full"
            placeholder="e.g., Where to eat dinner?"
          />
        </div>
        <h3 className="text-center mt-4 mb-2">How many choices can each person pick?</h3>
